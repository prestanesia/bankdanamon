...
$cart = $context->cart;
$bankwire = Module::getInstanceByName('bankdanamon');
...
$bankwire->validateOrder($cart->id, Configuration::get('PS_OS_BANKDANAMON'), $total, $bankwire->displayName, null, array(), (int)$currency->id, false, $customer->secure_key);
